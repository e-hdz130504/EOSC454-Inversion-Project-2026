...
class Simpeg1D:
    ...
    def run_fixed_layer_inversion(
        ...
        **kwargs,
        ...
        rx_locs = kwargs.get("rx_locs", np.array([[0.0]]))
        receivers_list = [
            nsem.receivers.Impedance(rx_locs, component="apparent_resistivity"),
            nsem.receivers.Impedance(rx_locs, component="phase"),
        ]
